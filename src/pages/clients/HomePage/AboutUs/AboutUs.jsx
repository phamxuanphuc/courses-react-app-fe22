          ...
          <div className="container">
            <div className="section-title mb-0 pb-2">
              ...
              <span>
                ...
                excepturi perferendis voluptatem asperiores rem accusamus
                cupiditate rerum commodi earum.
              </span>
            </div>
              ...
              <div className="ourteam row">
                <div className="member col-lg-4 col-md-6">
                  <div className="wrap">
                    ...
                    <div
                      className="image set-bg"
                      style={{ backgroundImage: `url(${phucpham})` }}></div>
                    <div className="infor">
                      <h3>Phạm Xuân Phúc</h3>
                      <span>Web Developer</span>
                    </div>
                    <div className="hover_detail"></div>
                  </div>
                </div>
                <div className="member col-lg-4 col-md-6">
                  <div className="wrap">
                    ...
                    <div
                      className="image set-bg"
                      style={{ backgroundImage: `url(${phucdinh})` }}></div>
                    <div className="infor">
                ...
                <div className="member col-lg-4 col-md-6">
                  <div className="wrap">
                    ...
                    <div
                      className="image set-bg"
                      style={{ backgroundImage: `url(${danlu})` }}></div>
                    <div className="infor">
                      <h3>Đan Lư</h3>
                      <span>Web Developer</span>
                    </div>
